...
- [ear-job-visualization](#ear-job-visualization)
- [Graphana](#Grafana)
...
```
ear-job-visualizer --format runtime -j 6043213 -s 0  -t palabos_8_nodes -o palabos_8.png -m cpi gflops gbs dc_power pck_power perc_mpi io_mbs
```
